                        ...
                        <div class="card-body">
                            <div class="card-text">
                                <p>
                                    ...
                                    <a href="{{route('admin.roles.index')}}"><span class="float-right">View All Roles
                            ...
                            <form class="form form-horizontal" action="{{route('admin.roles.store')}}" method="post">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="eventRegInput2" value="web" class="form-control" placeholder="web..." name="guard_name">
                                        </div>
                                    </div>
                                </div>
