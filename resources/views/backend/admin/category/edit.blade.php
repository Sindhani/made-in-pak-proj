                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>
                                    Edit Category
                                    <a href="{{route('admin.category.index')}}"><span class="float-right">View All Categories
                            ...
                            <form class="form form-horizontal" action="{{route('admin.category.update', $category->id)}}" method="post">
                                ...
                                <div class="form-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="eventRegInput1" class="form-control" placeholder="Computers.." name="name"
                                            value="{{$category->name}}">
                                        </div>
                                    </div>
