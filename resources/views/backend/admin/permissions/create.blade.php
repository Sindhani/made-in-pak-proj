                        ...
                        <div class="card-body">
                            <div class="card-text">
                                <p>
                                    ...
                                    <a href="{{route('admin.permissions.index')}}"><span class="float-right">View All Permissions
                            ...
                            <form class="form form-horizontal" action="{{route('admin.permissions.store')}}"
                                ...
                                <div class="form-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="eventRegInput1" class="form-control"
                                                   placeholder="can add product.." name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="eventRegInput2" value="web" class="form-control"
                                                   placeholder="web..." name="guard_name">
                                        </div>
                                    </div>
                                </div>
