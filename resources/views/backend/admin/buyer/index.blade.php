            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <p class="card-text">The Following table show a complete list of all registered customers in the
                            system.<a href="{{route('admin.buyers.create')}}"><i class="mr-5 text-info ft-user-plus float-right" style="font-size: 30px;"></i></a></p>
